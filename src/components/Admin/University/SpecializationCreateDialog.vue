...
<template>
  <Dialog
      ...
      modal
      header="Добавление новой специальности"
      :style="{ width: '40vw' }"
    ...
    <div class="formgrid grid">
      <div class="field col-12">
        <div class="flex flex-column gap-2">
          <label for="name" class="font-semibold">Наименование</label>
          <InputText
              id="name"
              v-model="form.name"
      ...
      <div class="field col-6">
        <div class="flex flex-column gap-2">
          <label for="middle_name" class="font-semibold">Требования</label>
          <Dropdown
              v-model="form.demand"
      ...
      <div class="field col-6">
        <div class="flex flex-column gap-2">
          <label for="last_name" class="font-semibold">Минимальный балл для гранта</label>
          <InputNumber
      ...
      <div class="field col-6">
        <div class="flex flex-column gap-2">
          <label for="last_name" class="font-semibold">Количество грантов</label>
          <InputNumber
      ...
      <div class="field col-6">
        <div class="flex flex-column gap-2">
          <label for="last_name" class="font-semibold">Средняя зарплата</label>
          <InputNumber
      ...
      <div class="field col-6">
        <div class="flex flex-column gap-2">
          <label for="last_name" class="font-semibold">Предметы</label>
          <MultiSelect
